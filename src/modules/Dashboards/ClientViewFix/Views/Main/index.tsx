...
function GanttView() {
  ...
  async function getDashboard({ Filters, Desc, OrderByField }: IDashboardGET) {
    dispacth({
    ...
    try {
      const { data } = await axiosInstance(
        _GET({ Filters, Desc, OrderByField })
      );
      dispacth({
            ...
            <span
              ...
              onClick={() => {
                getDashboard({
                  ...
                  OrderByField: "DataHoraInicioCliente",
                  Desc: dataHoraInicio,
                });
          ...
          <div className="cnx-custom-short-container-th-re-order">
            ...
            <span
              ...
              onClick={() => {
                getDashboard({
                  Filters: handleQueryString(filters),
                  OrderByField: "DataHoraFimCliente",
                  Desc: dataHoraFim,
                });
