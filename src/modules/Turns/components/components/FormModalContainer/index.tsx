...
function FormModalContainer() {
  ...
  function addformCheck() {
    ...
    if (addHoraInicioRef.current.value === '') {
      addHoraInicioRef.current!.classList?.add('cnx-input-border-error-highlight');
  ...
  function editformCheck() {
    ...
    if (editHoraInicioRef.current.value === '') {
      editHoraInicioRef.current!.classList?.add('cnx-input-border-error-highlight');
          ...
          <>
            <>
              <Input
                ...
                type="text"
                onChange={() => {
                  addCodigoRef.current!.classList?.remove('cnx-input-border-error-highlight');
                }}
                label="Código"
                mandatory
              />
          ...
          <>
            <>
              ...
              <Input
                ...
                mandatory
                onChange={() => {
                  editCodigoRef.current!.classList?.remove('cnx-input-border-error-highlight');
                }}
              />
              <Input
