      ...
      <div className="cnx-user-breadcrumbs-cub">
        {page === "list" ? (
          <>
            ...
            >
              <PublicCalendarIcon className="cnx-icon-calendar-crumb-color-ciccc cnx-user-hint-crumb-cuhc" />
              Calendário
            </button>
          </>
        ) : null}
        {page === "calendar" ? (
          <>
            ...
            <button
              ...
              onClick={() => setActivePage("calendar")}
            >
              <PublicCalendarIcon className="cnx-icon-calendar-crumb-color-ciccc" />
              Calendário
            </button>
          </>
        ) : null}
