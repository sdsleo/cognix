  ...
  const customTdFunction = [
    ...
    },
    {
      ...
      func: (data: any, key: any, rowValue: any) => {
        return <span style={{ fontSize: '0.9rem' }} className="searchable">{rowValue?.customVehicle?.plate}</span>;
      },
    },
    {
      key: "resourceId",
      func: (data: any, key: any, rowValue: any) => {
        return <span style={{ fontSize: '0.9rem' }} className="searchable">{rowValue?.resource?.code}</span>;
      },
    },
    {
      key: "status",
      func: (dataTd: any) => {
        switch (dataTd) {
          case 1:
            return <span className="searchable">Programado</span>;
          case 2:
            return <span className="searchable">Em manutenção</span>;
          case 3:
            return <span className="searchable">Encerrado</span>;
          case 4:
            return <span className="searchable">Cancelado</span>;
          default:
            return <span className="searchable">-</span>;
        }
      },
    },
  ];
