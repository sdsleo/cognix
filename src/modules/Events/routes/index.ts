...
export function _GET({ PageSize, PageNumber }: IPagination) {
  return {
    method: "get",
    url: `${window.apis.core}${url}production-loss/paged`,
    params: {
      PageSize,
      PageNumber,
    },
...
export function _POST(body: any) {
  return {
    method: "post",
    url: `${window.apis.core}${url}production-loss`,
    data: {...body}
  };
}
...
export function _DELETE(ids: any) {
  return {
    method: "delete",
    url: `${window.apis.core}${url}production-loss/range`,
    data: ids,
  };
}

export function _GET_EVENT_TYPES() {
  return {
    method: "get",
